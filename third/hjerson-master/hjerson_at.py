...
#AT print lenghts + joint lexical choice
write_error_rates(sys.stdout, "Length Wer:  ", totalWerRefLength, 0)
write_error_rates(sys.stdout, "Length Hyp:  ", totalHypLength, 0)

totalLexChoice = ( totalMissErr + totalExtErr + totalhLexErr) / 3
#TBD try the code
#AT end
